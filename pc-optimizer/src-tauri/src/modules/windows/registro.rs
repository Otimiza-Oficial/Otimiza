...
pub static FORA_DO_CATALOGO: &[Alteracao] = &[
    ...
    Alteracao {
        ...
        modulo: "governador",
        o_que_muda: "Enquanto o jogo roda, programas de fundo que estão disputando processador passam para prioridade baixa e modo econômico. Nada é fechado nem congelado.",
        risco: Risco::Baixo,
        escopo: Escopo::Windows,
        precisa_reiniciar: false,
        refaz_sozinho: false,
        desfazer: "Volta sozinho quando o jogo fecha, e na abertura seguinte do Otimiza.",
    },
    Alteracao {
