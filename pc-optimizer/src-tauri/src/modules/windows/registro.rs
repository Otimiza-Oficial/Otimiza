...
pub static FORA_DO_CATALOGO: &[Alteracao] = &[
    ...
    Alteracao {
        ...
        modulo: "nvdriver",
        o_que_muda: "Fila de quadros pré-renderizados, filtro de textura, cache de shader e o tamanho dele (sem limite: o cache passa a ocupar mais espaço no disco do sistema) no perfil global do driver.",
        risco: Risco::Medio,
    ...
    Alteracao {
        ...
        titulo: "Perfil NVIDIA de um jogo (versões até a 2.9)",
        modulo: "nvdriver",
        o_que_muda: "Aplicado por versões até a 2.9, na ficha da Biblioteca: energia e fila de quadros (e filtro de textura na Baixa latência) no perfil do executável do jogo. A 3.0 não aplica mais; só desfaz o que ficou.",
        risco: Risco::Medio,
        escopo: Escopo::Driver,
        precisa_reiniciar: false,
        refaz_sozinho: false,
    ...
    Alteracao {
        ...
        titulo: "Configuração gráfica de jogo em Unreal Engine (versões até a 2.9)",
        modulo: "unreal",
        o_que_muda: "Aplicado por versões até a 2.9, na ficha da Biblioteca: sombras, pós-processamento, efeitos e folhagem no arquivo de configuração do jogo. A 3.0 não aplica mais; só desfaz o que ficou.",
        risco: Risco::Medio,
        escopo: Escopo::Jogo,
        precisa_reiniciar: false,
        refaz_sozinho: false,
